...
# Form implementation generated from reading ui file 'interfacecamera_19_01.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_load_settings = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_load_settings.setGeometry(QtCore.QRect(400, 280, 111, 28))
    ...
    ####Put here the messages
        # self.pushButton_start.clicked.connect(self.clicked_me)
        # self.pushButton_close.clicked.connect(self.clicked_me)
        self.pushButton_start.clicked.connect(self.start_camera)
        self.pushButton_load_settings.clicked.connect(self.clicked_me)
        #(AndorEmccd().set_em_gain(10) ,AndorEmccd().set_preamp_gain(10),AndorEmccd().set_exposure_time(20),AndorEmccd().set_temperature(20),AndorEmccd().set_shutter_open(False))

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.label_settings.setToolTip(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">Camera Settings</span></p></body></html>"))
        self.label_settings.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; color:#000000;\">Camera Settings</span></p></body></html>"))
        self.label_exposuretime.setText(_translate("MainWindow", "<html><head/><body><p align=\"justify\"><span style=\" font-size:7pt;\">Exposure Time(s)</span></p></body></html>"))
    ...
    def clicked_me(self):
            ...
            print(settings['Settings']['Temperature'])
            self.lineEdit_temperature.setText(settings['Settings']['Temperature'])
            self.lineEdit_preamp.setText(settings['Settings']['pre_amp'])
            self.lineEdit_gain.setText(settings['Settings']['em_gain'])
            self.lineEdit_Exposuretime.setText(settings['Settings']['exposure_time'])
